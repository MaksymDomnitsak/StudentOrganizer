...
public class ScheduleController {
    ...
    @GetMapping(value = "/getGroups", params = {"teacherId"})
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<List<Group>> getGroups(@RequestParam("teacherId") Long teacherId){
        return ResponseEntity.ok(scheduleService.getGroupsFromScheduleByTeacherId(teacherId));
    }
